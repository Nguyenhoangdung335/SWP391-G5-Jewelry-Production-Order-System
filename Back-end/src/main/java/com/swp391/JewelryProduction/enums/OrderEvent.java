...
public enum OrderEvent {
    ...
    BET_TRANSACTION_MAKE,   //Transition from AWAIT_TRANSACTION TO BET_TRANSACTION_PROCESS
    BET_TRANSACTION_APPROVE,//Transition from BET_TRANSACTION_APPROVED TO IN_DESIGNING
    BET_TRANSACTION_DECLINE,//Transition from BET_TRANSACTION_DECLINED TO AWAIT_TRANSACTION
    ...
    DELIVERED_APPROVE,      //TRANSITION FROM DELIVERED_CONFIRMED TO AWAIT_REMAIN_TRANSACTION
    DELIVERED_DENY,         //TRANSITION FROM DELIVERED_DENIED TO ON_DELIVERING

    REMAIN_TRANSACTION_MAKE,    //TRANSITION FROM AWAIT_REMAIN_TRANSACTION TO REMAIN_TRANSACTION_PROCESS
    REMAIN_TRANSACTION_APPROVE, //TRANSITION FROM REMAIN_TRANSACTION_APPROVED TO ORDER_COMPLETED
    REMAIN_TRANSACTION_DECLINE, //TRANSITION FROM REMAIN_TRANSACTION_DECLINED TO AWAIT_REMAIN_TRANSACTION
