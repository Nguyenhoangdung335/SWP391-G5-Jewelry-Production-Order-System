                ...
                <Form onSubmit={handleSubmit} className="mb-5">
                    ...
                    <Form.Group className="mb-3">
                        ...
                        >
                            ...
                            <option value="Informal gathering">
                                Informal gathering
                            </option>
                                ...
                                <>
                                    <Form.Group className="mb-3">
                                        ...
                                        <Form.Select
                                            ...
                                            onChange={(e) =>
                                                setSelectedGemShape(e.target.value)
                                            }
                                            size="sm"
                                        >
                                            <option value="Round">Round</option>
                                            <option value="Radiant">Radiant</option>
                                            <option value="Square Radiant">
                                                Square Radiant
                                            </option>
                                    ...
                                    <Form.Group className="mb-3">
                                        <Form.Label>
                                            Gemstone Weight: {selectedGemWeight}{" "}
                                            carats
                                        </Form.Label>
                                        <Form.Range
                                            step="0.25"
                                            ...
                                            onChange={(e) =>
                                                setSelectedGemWeight(e.target.value)
                                            }
                                        />
                                    </Form.Group>
                                </>
        ...
        <div className="mb-4">
            ...
            Contact us
                ...
                <Modal show={showModal} onHide={() => {
                    ...
                    if (productSpecId) {
                        axios.post(`${ServerUrl}/api/products/remove/${productSpecId}`)
                            .then(response => {
