...
const GemstoneList = () => {
    ...
    useEffect(() => {
        const fetchGemstones = async () => {
            try {
                const response = await axios.get(`${ServerUrl}/api/gemstone?page=0&size=174&sortBy=id`);
    ...
    const filteredGemstones = gemstones.filter(gemstone => {
        return (
            ...
            (caratWeight === 0 || (gemstone.caratWeightFrom <= caratWeight && gemstone.caratWeightTo >= caratWeight)) &&
    ...
    return (
        <Container className="pt-5 pb-4 w-75 d-flex flex-column" style={{height: "91vh"}}>
                ...
                <Col md={4}>
                    <div className="filter-group carat-weight-filter">
                        ...
                        <div className="slider-container d-flex align-items-center">
                            ...
                            />
                            <span className="ml-3 font-weight-bold">{caratWeight.toFixed(2)}</span>
                        </div>
                    </div>
                </Col>
                <Col md={4}>
